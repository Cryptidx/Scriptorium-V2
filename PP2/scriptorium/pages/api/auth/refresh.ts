...
const ACCESS_TOKEN_SECRET = process.env.JWT_SECRET_ACCESS as string;
const REFRESH_TOKEN_SECRET = process.env.JWT_SECRET_REFRESH as string;
...
export default async function handler(req: RefreshTokenRequest, res: RefreshTokenResponse) {
  if (req.method !== 'POST') {
